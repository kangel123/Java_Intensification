...
public class ReadNumbers {
	...
	public static void readNumbers2() {
		int kopo09_iNumVal = 1001034567;	// kopo09_iNumVal는 int형 10자리 숫자까지 가능
		...
		while(true) {	// 반복문
			...
			if(kopo09_sNumVal.substring(kopo09_sNumVal_Index, kopo09_sNumVal_Index+1).equals("0")) {	// 앞에서부터 kopo09_sNumVal_Index번째의 값이 0인 경우. substring : 글자 자르는 함수
				if(kopo09_units[kopo09_units_Index].equals("만") || kopo09_units[kopo09_units_Index].equals("억") ) {		// 읽고 있는 숫자 단위가 만이랑 억이면
