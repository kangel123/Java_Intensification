...
public class OneRec2 {
	...
	OneRec2(int kopo09_student_id, String kopo09_name, int kopo09_kor, int kopo09_eng, int kopo09_mat) { // 특정 생성자 생성
		this.kopo09_student_id = kopo09_student_id;	// ID 저장
	...
	public int student_id(){return this.kopo09_student_id;};	// ID 반환
