...
public class MethodTest3 {
	...
	public static final String[] kopo09_itemname = { "초코파이", "바나나우유", "건포도", "오렌지주스", "초코에몽", "마스크", "식용유1.8L",
			...
			"푸르밀 미숫가루우유", "오뚜기 진비빔면 156g", "(달콤)순살닭강정(g)", "CJ 비비고칩 20g", "1+ 등급란 10개입 특", "물티슈 캡형", "포르쉐 718", "사과" }; // 구매 물품명
	...
	public static void main(String[] args) {
		...
		int kopo09_itemCount = 32;	// 출력할 항목 개수
		TitlePrint(); // 영수증 타이틀 인쇄
		TimeStemp(); // 출력시간 인쇄
		HeaderPrint(); // 헤더(상품명,단가,수량,금액)인쇄
		for (int kopo09_i = 0; kopo09_i < kopo09_itemCount; kopo09_i++) {	// 항목 개수만큼 해당 항목 출력
			ItemPrint(kopo09_i);
		}
