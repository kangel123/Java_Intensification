...
public class Receipt2 {
	...
	public static void receipt2() {
		...
		// 첫번째 항목 정보
		String kopo09_itemname1 = "퓨어에어 비말차단용마스크(최고급형)";	//상품명
		String kopo09_itemcode1 = "1031615";	//상품번호
		int kopo09_price1 = 3000;	//가격
		int kopo09_amount1 = 1;	//구매 개수

		// 두번째 항목 정보
		String kopo09_itemname2 = "슬라이드식명찰(가로형)(100호)";	//상품명
		String kopo09_itemcode2 = "11008152";	//상품번호
		int kopo09_price2 = 1000;	//가격
		int kopo09_amount2 = 1;	//구매 개수

		// 세번째 항목 정보
		String kopo09_itemname3 = "매직흡착 인테리어후크(알루미늄타입)";	//상품명
		String kopo09_itemcode3 = "1020800";	//상품번호
		int kopo09_price3 = 10000;	//가격
		int kopo09_amount3 = 50;	//구매 개수
		...
		System.out.printf("=========================================\n"); // 인증 정보
		System.out.printf("%24s\n", "소비자중심경영(CCM) 인증기업");	// CCM 인증
		System.out.printf("%26s\n", "ISO 9001 품질경영시스템 인증기업");	// ISO 인증
		System.out.printf("========================================\n"); // 교환/환불 정보
		System.out.printf("%11s 14일(%d월 %d일)이내,\n", "교환/환불", kopo09_future.get(Calendar.MONTH) + 1, kopo09_future.get(Calendar.DATE)); // 교환/환불 날짜를 Calendar함수를 사용하여 표현
		System.out.printf("%23s\n", "(전자)영수증, 결제카드 지참 후");	// 한줄에 표현 불가능이라 2줄로 맞춤
