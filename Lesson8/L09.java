...
public class L09 {
	...
	public static void main(String[] args) throws IOException { // csv 파일 읽기
		...
		File kopo09_f1 = new File("C:\\Users\\kjw\\Desktop\\day_data\\A005930.csv"); // 쓰기 할 파일
		...
		int kopo09_wcnt = 0; // A005930.csv의 줄 번호
		...
		while ((kopo09_readtxt = kopo09_br.readLine()) != null) { // readLine()을 사용해 한줄 단위로 kopo09_readtxt에 저장
			...
			if (code.equals("A005930")) {	// 코드가 A005930인 경우
				...
				kopo09_wcnt++;	// A005930.csv의 줄 번호 증가
			}
